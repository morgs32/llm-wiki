...
The browser obtains its signature from the session, builds the exact
generation/account/actor/frontend Durable Object name, converts the configured
API URL to `ws:` or `wss:`, and subscribes at
...
ignored (../../packages/react/src/acquireFrontendWebSocket.ts:15-140).
