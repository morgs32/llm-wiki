...
function CommandInput({
  ...
  return (
    <div
      ...
      className={cn(sm ? "p-0" : "p-1 pb-0")}
    >
      <InputGroup
        className={cn(
          "border-input/30 shadow-none! *:data-[slot=input-group-addon]:pl-2!",
          sm
            ? "h-9! rounded-md! border border-border bg-background shadow-xs! *:data-[slot=input-group-addon]:pl-2.5! [&_svg]:size-3.5!"
            : "bg-input/30 h-8! rounded-lg!",
        )}
      >
        <CommandPrimitive.Input
          ...
          className={cn(
            ...
            sm && "pl-2 pr-3 text-base md:text-sm",
            className,
          )}
          {...props}
        />
